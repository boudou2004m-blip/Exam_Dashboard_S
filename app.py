                        ...
                        for slot in slots:
                            ...
                            for gi, group in enumerate(groups, 1):
                                ...
                                for _, r in rooms.iterrows():
                                    if r.capacity >= len(group) and r.id not in used_rooms:
                                        if slot not in room_bookings.get(r.id, set()):
                                            room = r
                                            break
                                ...
                                for p in sorted_profs:
                                    if professor_exams.get(p["id"], {}).get(exam_date, 0) >= 3:
                                        continue
                            ...
                            if len(temp) == len(groups):
                                for gi, group, room, prof in temp:
                                    ...
                                    professor_exams[prof["id"]][exam_date] = professor_exams[prof["id"]].get(exam_date, 0) + 1
